...
if __name__ == "__main__":
    ...
    sample_dict = {"Gibbs": {"horizons": {10: 0, 25:0, 50: 0, 100:0, 200:0}}, "HMC": {"horizons": {10: 0, 25:0, 50: 0, 100:0, 200:0}}}
    for h, t in list_of_horizons_time:
        ...
        alg_h = psrl.PSRL(env=ToyEnv.ToyEnv(4, 3, 2, seed), sampler=HMCpymcGMM, H = h, T = t)
